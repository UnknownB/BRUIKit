...
extension BRWrapper where Base == UIColor {
    ...
    /// RGBA (紅/綠/藍/透明度)
    public static func fromRGBA(color: (red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat)) -> UIColor {
    ...
    /// RGB Hex Code
    public static func fromRGBHex(_ hex: Int, alpha: CGFloat = 1.0) -> UIColor {
        UIColor(
    ...
    /// HSL (色相/飽和度/亮度)
    public static func fromHSL(hue: CGFloat, saturation: CGFloat, lightness: CGFloat, alpha: CGFloat = 1) -> UIColor {
    ...
    /// HSL (色相/飽和度/亮度)
    public static func fromHSL(color: (hue: CGFloat, saturation: CGFloat, lightness: CGFloat, alpha: CGFloat)) -> UIColor {
